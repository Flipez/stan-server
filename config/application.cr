...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Stan web application."
  #
  #
  ...
  #
  # settings.secret_key_base= gWWNwCBftaigD2rGNc1QwasEF5dVcg4emz1sczBKWgc
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("stan.log", "w"))
  #
  #
end
